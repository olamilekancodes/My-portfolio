  ...
  return (
    <div className="py-10 mt-0 xl:mt-10">
      <PageTitle
        ...
        paragraph="Crafting seamless and visually engaging user experiences is my passion. As a software engineer focusing on frontend development, I put my creativity and attention to detail into every project, turning ideas into responsive and functional websites and applications."
      />
